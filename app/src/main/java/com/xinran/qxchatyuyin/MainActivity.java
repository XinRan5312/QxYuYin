package com.xinran.qxchatyuyin;
...
public class MainActivity extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mStartYuYinbtn=$(this,R.id.button1);
        mStartYuYinbtn.setOnClickListener(new View.OnClickListener() {
            @Override
    ...
    private <T extends View> T $(Activity activity, int id) {
